...
func CreateDatabase3(ctx context.Context, txn txnif.AsyncTxn, dbName, createsql, dattype string) (handle.Database, error) {
...
func CreateDatabase2(ctx context.Context, txn txnif.AsyncTxn, dbName string) (handle.Database, error) {
	return CreateDatabase3(ctx, txn, dbName, "", "")
}
