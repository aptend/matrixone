...
create table test_bigint (a bigint unsigned);
insert into test_bigint values (0xFFFFFFFFFFFFFFFD);
insert into test_bigint values (0xFFFFFFFFFFFFFFFE);
select * from test_bigint where a -1 > 1;
select * from test_bigint where a > 1;
