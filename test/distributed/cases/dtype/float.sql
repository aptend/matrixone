...
drop table if exists t1;
create table t1(a float);
insert into t1 values(3214321.213);
select cast(a as varchar) from t1;
insert into t1 values(1234567891234567.1234);
insert into t1 values(0.00000000000001);
select cast(a as varchar) from t1;