...
// StreamTeardownMode negotiates whether a completed logical pipeline stream can
// be retired without closing its exclusive TCP backend. Zero intentionally
// preserves the legacy close-the-backend behavior for rolling upgrades.
type StreamTeardownMode int32

const (
	StreamTeardownMode_LegacyClose StreamTeardownMode = 0
	StreamTeardownMode_FinishAck   StreamTeardownMode = 1
)

var StreamTeardownMode_name = map[int32]string{
	0: "LegacyClose",
	1: "FinishAck",
}

var StreamTeardownMode_value = map[string]int32{
	"LegacyClose": 0,
	"FinishAck":   1,
}

func (x StreamTeardownMode) String() string {
	return proto.EnumName(StreamTeardownMode_name, int32(x))
}

func (StreamTeardownMode) EnumDescriptor() ([]byte, []int) {
...
func (m *Message) GetRequestedTeardownMode() StreamTeardownMode {
	if m != nil {
		return m.RequestedTeardownMode
	}
	return StreamTeardownMode_LegacyClose
}

func (m *Message) GetAcceptedTeardownMode() StreamTeardownMode {
	if m != nil {
		return m.AcceptedTeardownMode
	}
	return StreamTeardownMode_LegacyClose
}
...
type Insert struct {
	...
	ExternalStmtUnixNano int64    `protobuf:"varint,12,opt,name=external_stmt_unix_nano,json=externalStmtUnixNano,proto3" json:"external_stmt_unix_nano,omitempty"`
...
func (m *HashJoin) Reset()         { *m = HashJoin{} }
func (m *HashJoin) String() string { return proto.CompactTextString(m) }
...
func (m *HashJoin) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HashJoin.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HashJoin) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HashJoin.Merge(m, src)
}
...
var xxx_messageInfo_HashJoin proto.InternalMessageInfo

func (m *HashJoin) GetJoinType() plan.Node_JoinType {
	if m != nil {
		return m.JoinType
	}
	return plan.Node_INNER
}

func (m *HashJoin) GetIsRightJoin() bool {
	if m != nil {
		return m.IsRightJoin
	}
	return false
}
...
func (m *LoopJoin) Reset()         { *m = LoopJoin{} }
func (m *LoopJoin) String() string { return proto.CompactTextString(m) }
...
func (m *LoopJoin) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LoopJoin.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LoopJoin) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LoopJoin.Merge(m, src)
}
func (m *LoopJoin) XXX_Size() int {
	return m.ProtoSize()
}
func (m *LoopJoin) XXX_DiscardUnknown() {
	xxx_messageInfo_LoopJoin.DiscardUnknown(m)
}

var xxx_messageInfo_LoopJoin proto.InternalMessageInfo
...
func (m *SetOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SetOp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SetOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetOp.Merge(m, src)
}
func (m *SetOp) XXX_Size() int {
	return m.ProtoSize()
}
func (m *SetOp) XXX_DiscardUnknown() {
	xxx_messageInfo_SetOp.DiscardUnknown(m)
}
...
func (m *DedupJoin) GetOldColCapturePlaceholderIdxList() []int32 {
	if m != nil {
		return m.OldColCapturePlaceholderIdxList
	}
	return nil
}
...
func (m *DedupJoin) GetOldColCaptureProbeIdxList() []int32 {
	if m != nil {
		return m.OldColCaptureProbeIdxList
	}
	return nil
}
...
func (m *DedupJoin) GetDedupDeleteKeepColIdxList() []int32 {
	if m != nil {
		return m.DedupDeleteKeepColIdxList
	}
	return nil
}
...
func (m *DedupJoin) GetDedupDeleteMarkerColIdx() int32 {
	if m != nil {
		return m.DedupDeleteMarkerColIdx
	}
	return 0
}
...
func (m *TableFunction) GetIndexReaderParam() *plan.IndexReaderParam {
	if m != nil {
		return m.IndexReaderParam
	}
	return nil
}
...
func (m *ParquetRowGroupShard) Reset()         { *m = ParquetRowGroupShard{} }
func (m *ParquetRowGroupShard) String() string { return proto.CompactTextString(m) }
...
func (m *ParquetRowGroupShard) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ParquetRowGroupShard.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ParquetRowGroupShard) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParquetRowGroupShard.Merge(m, src)
}
func (m *ParquetRowGroupShard) XXX_Size() int {
	return m.ProtoSize()
}
func (m *ParquetRowGroupShard) XXX_DiscardUnknown() {
	xxx_messageInfo_ParquetRowGroupShard.DiscardUnknown(m)
}

var xxx_messageInfo_ParquetRowGroupShard proto.InternalMessageInfo
...
func (m *ExternalScan) GetLoadEmptyNumericAsZero() bool {
	if m != nil {
		return m.LoadEmptyNumericAsZero
	}
	return false
}
...
type HashBuild struct {
	...
	OnDuplicateAction         plan.Node_OnDuplicateAction `protobuf:"varint,12,opt,name=on_duplicate_action,json=onDuplicateAction,proto3,enum=plan.Node_OnDuplicateAction" json:"on_duplicate_action,omitempty"`
	...
	DedupDeleteMarkerColIdx   int32                       `protobuf:"varint,17,opt,name=dedup_delete_marker_col_idx,json=dedupDeleteMarkerColIdx,proto3" json:"dedup_delete_marker_col_idx,omitempty"`
	DedupDeleteKeepColIdxList []int32                     `protobuf:"varint,18,rep,packed,name=dedup_delete_keep_col_idx_list,json=dedupDeleteKeepColIdxList,proto3" json:"dedup_delete_keep_col_idx_list,omitempty"`
	TrackNullKeys             bool                        `protobuf:"varint,19,opt,name=track_null_keys,json=trackNullKeys,proto3" json:"track_null_keys,omitempty"`
	XXX_NoUnkeyedLiteral      struct{}                    `json:"-"`
	XXX_unrecognized          []byte                      `json:"-"`
	XXX_sizecache             int32                       `json:"-"`
}
...
func (m *HashBuild) GetTrackNullKeys() bool {
	if m != nil {
		return m.TrackNullKeys
	}
	return false
}
...
type Instruction struct {
	...
	// gated by MORPCVersion38 until every participant understands them.
	ProjectionGroupingFlags    []bool   `protobuf:"varint,59,rep,packed,name=projection_grouping_flags,json=projectionGroupingFlags,proto3" json:"projection_grouping_flags,omitempty"`
	ProjectionGroupingSetCount int32    `protobuf:"varint,60,opt,name=projection_grouping_set_count,json=projectionGroupingSetCount,proto3" json:"projection_grouping_set_count,omitempty"`
	XXX_NoUnkeyedLiteral       struct{} `json:"-"`
	XXX_unrecognized           []byte   `json:"-"`
	XXX_sizecache              int32    `json:"-"`
}
...
func init() {
	...
	proto.RegisterType((*HashJoin)(nil), "pipeline.HashJoin")
	proto.RegisterType((*LoopJoin)(nil), "pipeline.LoopJoin")
	proto.RegisterType((*SetOp)(nil), "pipeline.SetOp")
...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RequestedTeardownMode != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.RequestedTeardownMode))
		i--
		dAtA[i] = 0x58
	}
	if len(m.DebugMsg) > 0 {
...
func (m *Group) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GroupByHashKey) > 0 {
		dAtA12 := make([]byte, len(m.GroupByHashKey)*10)
		var j11 int
	...
	if len(m.PartialResultTypes) > 0 {
		dAtA14 := make([]byte, len(m.PartialResultTypes)*10)
		var j13 int
...
func (m *Insert) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ExternalTzOffsetSec != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.ExternalTzOffsetSec))
		i--
		dAtA[i] = 0x70
	}
	if len(m.ExternalTzName) > 0 {
		i -= len(m.ExternalTzName)
		copy(dAtA[i:], m.ExternalTzName)
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.ExternalTzName)))
		i--
		dAtA[i] = 0x6a
	}
	if m.ExternalStmtUnixNano != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.ExternalStmtUnixNano))
		i--
		dAtA[i] = 0x60
	}
	if m.ToExternal {
	...
	if len(m.PartitionTableIds) > 0 {
		dAtA17 := make([]byte, len(m.PartitionTableIds)*10)
		var j16 int
...
func (m *Array) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Array) > 0 {
		dAtA20 := make([]byte, len(m.Array)*10)
		var j19 int
...
func (m *Deletion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PartitionTableIds) > 0 {
		dAtA23 := make([]byte, len(m.PartitionTableIds)*10)
		var j22 int
		for _, num := range m.PartitionTableIds {
			for num >= 1<<7 {
...
func (m *HashJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.NonEqCond != nil {
		{
			size, err := m.NonEqCond.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.RightConds) > 0 {
		for iNdEx := len(m.RightConds) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RightConds[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.LeftConds) > 0 {
		for iNdEx := len(m.LeftConds) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LeftConds[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *DedupJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DedupDeleteKeepColIdxList) > 0 {
		dAtA49 := make([]byte, len(m.DedupDeleteKeepColIdxList)*10)
		var j48 int
	...
	if len(m.OldColCaptureProbeIdxList) > 0 {
		dAtA51 := make([]byte, len(m.OldColCaptureProbeIdxList)*10)
		var j50 int
	...
	if len(m.OldColCapturePlaceholderIdxList) > 0 {
		dAtA53 := make([]byte, len(m.OldColCapturePlaceholderIdxList)*10)
		var j52 int
	...
	if len(m.UpdateColIdxList) > 0 {
		dAtA55 := make([]byte, len(m.UpdateColIdxList)*10)
		var j54 int
...
func (m *RightDedupJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA63 := make([]byte, len(m.ColList)*10)
		var j62 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA65 := make([]byte, len(m.RelList)*10)
		var j64 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *IndexJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		dAtA76 := make([]byte, len(m.Result)*10)
		var j75 int
...
func (m *TableFunction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.IndexReaderParam != nil {
		{
			size, err := m.IndexReaderParam.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *FileOffset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Offset) > 0 {
		dAtA81 := make([]byte, len(m.Offset)*10)
		var j80 int
...
func (m *ParquetRowGroupShard) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Bytes != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.Bytes))
		i--
		dAtA[i] = 0x28
	}
	if m.NumRows != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.NumRows))
		i--
		dAtA[i] = 0x20
	}
	if m.RowGroupEnd != 0 {
...
func (m *IcebergDataFileTask) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SplitOffsets) > 0 {
		dAtA83 := make([]byte, len(m.SplitOffsets)*10)
		var j82 int
...
func (m *IcebergDeleteFileTask) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EqualityFieldIds) > 0 {
		dAtA85 := make([]byte, len(m.EqualityFieldIds)*10)
		var j84 int
...
func (m *IcebergSnapshotRuntime) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PartitionSpecIds) > 0 {
		dAtA88 := make([]byte, len(m.PartitionSpecIds)*10)
		var j87 int
...
func (m *ExternalScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IcebergHiddenReadColumns) > 0 {
		dAtA94 := make([]byte, len(m.IcebergHiddenReadColumns)*10)
		var j93 int
		...
		i = encodeVarintPipeline(dAtA, i, uint64(j93))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x9a
	...
	if len(m.ParquetRowGroupShards) > 0 {
		for iNdEx := len(m.ParquetRowGroupShards) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ParquetRowGroupShards[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.FileSize) > 0 {
		dAtA98 := make([]byte, len(m.FileSize)*10)
		var j97 int
...
func (m *TableScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FilterExprs) > 0 {
		for iNdEx := len(m.FilterExprs) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.FilterExprs[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *HashBuild) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DedupDeleteKeepColIdxList) > 0 {
		dAtA100 := make([]byte, len(m.DedupDeleteKeepColIdxList)*10)
		var j99 int
		for _, num1 := range m.DedupDeleteKeepColIdxList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *Instruction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SetOp != nil {
		{
			size, err := m.SetOp.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.LoopJoin != nil {
		{
			size, err := m.LoopJoin.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.HashJoin != nil {
		{
			size, err := m.HashJoin.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Source) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MembershipFilter) > 0 {
		i -= len(m.MembershipFilter)
		copy(dAtA[i:], m.MembershipFilter)
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.MembershipFilter)))
		i--
		dAtA[i] = 0x72
	}
...
func (m *PrepareParamInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StringSources) > 0 {
		dAtA142 := make([]byte, len(m.StringSources)*10)
		var j141 int
...
func (m *Pipeline) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NilBatchCnt) > 0 {
		dAtA150 := make([]byte, len(m.NilBatchCnt)*10)
		var j149 int
	...
	if len(m.ChannelBufferSize) > 0 {
		dAtA152 := make([]byte, len(m.ChannelBufferSize)*10)
		var j151 int
		...
		i = encodeVarintPipeline(dAtA, i, uint64(j151))
		i--
		dAtA[i] = 0x62
	}
...
func (m *Apply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA158 := make([]byte, len(m.ColList)*10)
		var j157 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA160 := make([]byte, len(m.RelList)*10)
		var j159 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintPipeline(dAtA, i, uint64(j159))
		i--
		dAtA[i] = 0x12
	}
	if m.ApplyType != 0 {
...
func (m *Message) ProtoSize() (n int) {
	...
	if m.RequestedTeardownMode != 0 {
		n += 1 + sovPipeline(uint64(m.RequestedTeardownMode))
	}
	if m.AcceptedTeardownMode != 0 {
...
func (m *Insert) ProtoSize() (n int) {
	...
	if m.ExternalStmtUnixNano != 0 {
		n += 1 + sovPipeline(uint64(m.ExternalStmtUnixNano))
	}
	l = len(m.ExternalTzName)
	if l > 0 {
		n += 1 + l + sovPipeline(uint64(l))
	}
	if m.ExternalTzOffsetSec != 0 {
		n += 1 + sovPipeline(uint64(m.ExternalTzOffsetSec))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *HashJoin) ProtoSize() (n int) {
	...
	if len(m.LeftConds) > 0 {
		for _, e := range m.LeftConds {
			l = e.ProtoSize()
			n += 1 + l + sovPipeline(uint64(l))
		}
	}
	if len(m.RightConds) > 0 {
		for _, e := range m.RightConds {
			l = e.ProtoSize()
			n += 1 + l + sovPipeline(uint64(l))
		}
	}
	if m.NonEqCond != nil {
		l = m.NonEqCond.ProtoSize()
		n += 1 + l + sovPipeline(uint64(l))
	}
	if len(m.LeftTypes) > 0 {
...
func (m *DedupJoin) ProtoSize() (n int) {
	...
	if len(m.OldColCapturePlaceholderIdxList) > 0 {
		l = 0
		for _, e := range m.OldColCapturePlaceholderIdxList {
			l += sovPipeline(uint64(e))
		}
	...
	if len(m.OldColCaptureProbeIdxList) > 0 {
		l = 0
		for _, e := range m.OldColCaptureProbeIdxList {
			l += sovPipeline(uint64(e))
		}
		n += 2 + sovPipeline(uint64(l)) + l
	}
	...
	if len(m.DedupDeleteKeepColIdxList) > 0 {
		l = 0
		for _, e := range m.DedupDeleteKeepColIdxList {
			l += sovPipeline(uint64(e))
		}
		n += 2 + sovPipeline(uint64(l)) + l
	}
...
func (m *TableFunction) ProtoSize() (n int) {
	...
	if m.IndexReaderParam != nil {
		l = m.IndexReaderParam.ProtoSize()
		n += 1 + l + sovPipeline(uint64(l))
	}
	if len(m.RuntimeFilterProbeList) > 0 {
...
func (m *ParquetRowGroupShard) ProtoSize() (n int) {
	...
	if m.NumRows != 0 {
		n += 1 + sovPipeline(uint64(m.NumRows))
	}
	if m.Bytes != 0 {
...
func (m *ExternalScan) ProtoSize() (n int) {
	...
	if len(m.ParquetRowGroupShards) > 0 {
		for _, e := range m.ParquetRowGroupShards {
			l = e.ProtoSize()
			n += 1 + l + sovPipeline(uint64(l))
		}
	}
...
func (m *Instruction) ProtoSize() (n int) {
	...
	if m.HashJoin != nil {
		l = m.HashJoin.ProtoSize()
		n += 1 + l + sovPipeline(uint64(l))
	}
	if m.LoopJoin != nil {
		l = m.LoopJoin.ProtoSize()
		n += 1 + l + sovPipeline(uint64(l))
	}
	if m.SetOp != nil {
		l = m.SetOp.ProtoSize()
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestedTeardownMode", wireType)
			}
			m.RequestedTeardownMode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RequestedTeardownMode |= StreamTeardownMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AcceptedTeardownMode", wireType)
			}
			m.AcceptedTeardownMode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
...
func (m *Group) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpillMem", wireType)
			}
			m.SpillMem = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Insert) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ToExternal", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ToExternal = bool(v != 0)
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExternalStmtUnixNano", wireType)
			}
			m.ExternalStmtUnixNano = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExternalStmtUnixNano |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExternalTzName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExternalTzName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExternalTzOffsetSec", wireType)
			}
			m.ExternalTzOffsetSec = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExternalTzOffsetSec |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *HashJoin) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HashJoin: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HashJoin: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.JoinType |= plan.Node_JoinType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsRightJoin", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LeftConds", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LeftConds = append(m.LeftConds, &plan.Expr{})
			if err := m.LeftConds[len(m.LeftConds)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RightConds", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RightConds = append(m.RightConds, &plan.Expr{})
			if err := m.RightConds[len(m.RightConds)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NonEqCond", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.NonEqCond == nil {
				m.NonEqCond = &plan.Expr{}
			}
			if err := m.NonEqCond.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
...
func (m *LoopJoin) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LoopJoin: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LoopJoin: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType == 0 {
				...
				m.OldColCapturePlaceholderIdxList = append(m.OldColCapturePlaceholderIdxList, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.OldColCapturePlaceholderIdxList) == 0 {
					m.OldColCapturePlaceholderIdxList = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field OldColCapturePlaceholderIdxList", wireType)
			}
		case 18:
			if wireType == 0 {
				var v int32
				...
				m.OldColCaptureProbeIdxList = append(m.OldColCaptureProbeIdxList, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.OldColCaptureProbeIdxList) == 0 {
					m.OldColCaptureProbeIdxList = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field OldColCaptureProbeIdxList", wireType)
			}
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DedupBuildKeepLast", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 20:
			if wireType == 0 {
				...
				m.DedupDeleteKeepColIdxList = append(m.DedupDeleteKeepColIdxList, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.DedupDeleteKeepColIdxList) == 0 {
					m.DedupDeleteKeepColIdxList = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field DedupDeleteKeepColIdxList", wireType)
			}
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DedupDeleteMarkerColIdx", wireType)
			}
			m.DedupDeleteMarkerColIdx = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DedupDeleteMarkerColIdx |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *TableFunction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexReaderParam", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IndexReaderParam == nil {
				m.IndexReaderParam = &plan.IndexReaderParam{}
			}
			if err := m.IndexReaderParam.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
...
func (m *ParquetRowGroupShard) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: parquet_row_group_shard: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: parquet_row_group_shard: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ExternalScan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ParallelLoad", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ParallelLoad = bool(v != 0)
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LoadEmptyNumericAsZero", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LoadEmptyNumericAsZero = bool(v != 0)
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ParquetRowGroupShards", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ParquetRowGroupShards = append(m.ParquetRowGroupShards, &ParquetRowGroupShard{})
			if err := m.ParquetRowGroupShards[len(m.ParquetRowGroupShards)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 14:
...
func (m *TableScan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FilterExprs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FilterExprs = append(m.FilterExprs, &plan.Expr{})
			if err := m.FilterExprs[len(m.FilterExprs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *HashBuild) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TrackNullKeys", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Instruction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HashJoin", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.HashJoin.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LoopJoin", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LoopJoin.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
...
func (m *Source) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MembershipFilter", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MembershipFilter = append(m.MembershipFilter[:0], dAtA[iNdEx:postIndex]...)
			if m.MembershipFilter == nil {
				m.MembershipFilter = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
