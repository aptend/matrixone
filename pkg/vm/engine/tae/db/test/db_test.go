...
func TestAppend4(t *testing.T) {
	...
	schema1.Extra.BlockCntPerObj = 2
	schema2.Extra.BlockCntPerObj = 2
	schema3.Extra.BlockCntPerObj = 2
	schema4.Extra.BlockCntPerObj = 2
...
func testCRUD(t *testing.T, tae *db.DB, schema *catalog.Schema) {
	bat := catalog.MockBatch(schema, int(schema.Extra.BlockMaxRows*(uint32(schema.Extra.BlockCntPerObj)+1)-1))
	defer bat.Close()
	bats := bat.Split(4)
...
func TestFlushTableMergeOrder(t *testing.T) {
	...
	schema.Extra.BlockCntPerObj = 256
...
func TestMultiTenantMoCatalogOps(t *testing.T) {
	...
	schema11.Extra.BlockCntPerObj = 2
	...
	schema21.Extra.BlockCntPerObj = 2
...
func TestMergeMemsize(t *testing.T) {
	...
	schema.Extra.BlockCntPerObj = 200
	tae.BindSchema(schema)
...
func TestCollectDeletesAfterCKP(t *testing.T) {
	...
	schema.Name = "testupdate"
	schema.Extra.BlockMaxRows = 8192
	schema.Extra.BlockCntPerObj = 20
	tae.BindSchema(schema)
...
func TestSnapshotGC(t *testing.T) {
	...
	snapshotSchema.Extra.BlockCntPerObj = 1
	schema1 := catalog.MockSchemaAll(13, 2)
	schema1.Extra.BlockMaxRows = 10
	schema1.Extra.BlockCntPerObj = 2
...
func TestLogailAppend(t *testing.T) {
	...
	schema.Extra.BlockCntPerObj = 2
	tae.BindSchema(schema)
	batch := catalog.MockBatch(schema, int(schema.Extra.BlockMaxRows*uint32(schema.Extra.BlockCntPerObj)-1))
